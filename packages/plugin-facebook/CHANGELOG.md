...
* **plugin-facebook:** Log progress on info level. ([e50de0e](https://github.com/critocrito/sugarcube/commit/e50de0e)), closes [#30](https://github.com/critocrito/sugarcube/issues/30)


### Features

* **plugin-facebook:** Added option to limit the amount of feed messages fetched. ([f8247cd](https://github.com/critocrito/sugarcube/commit/f8247cd)), closes [#29](https://github.com/critocrito/sugarcube/issues/29)
* **plugin-facebook:** Fetch the feed of a Facebook page. ([9be0620](https://github.com/critocrito/sugarcube/commit/9be0620))
...
* **plugin-facebook:** Bad API use of dashp. ([4624ace](https://github.com/critocrito/sugarcube/commit/4624ace))
...
* Imported the facebook plugin. ([f19588d](https://github.com/critocrito/sugarcube/commit/f19588d))
