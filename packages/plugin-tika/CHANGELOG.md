...
* **plugin-tika:** Normalize text and meta in a more sane way. ([524bfd0](https://github.com/critocrito/sugarcube/commit/524bfd0))
...
* **plugin-tika:** Added the tika_export plugin. ([afe00b3](https://github.com/critocrito/sugarcube/commit/afe00b3))
* **plugin-tika:** Allow the tika_location plugin to parse more than one field. ([f2205f6](https://github.com/critocrito/sugarcube/commit/f2205f6))
...
* **plugin-tika:** In debug mode log all urls that are parsed by Tika. ([b4fea88](https://github.com/critocrito/sugarcube/commit/b4fea88))
...
* **plugin-tika:** Added the tika_location plugin. ([89ff82e](https://github.com/critocrito/sugarcube/commit/89ff82e))
* **plugin-tika:** Extract text and meta data from all links. ([f119d28](https://github.com/critocrito/sugarcube/commit/f119d28))
...
* Imported the tika plugin. ([9914084](https://github.com/critocrito/sugarcube/commit/9914084))
