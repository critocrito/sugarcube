...
* **plugin-http:** catch content-type parsing errors ([23535bb](https://github.com/critocrito/sugarcube/commit/23535bb))
...
* **plugin-http:** add optional ncube data format when importing websites ([81cfd68](https://github.com/critocrito/sugarcube/commit/81cfd68))
...
## [0.34.1](https://github.com/critocrito/sugarcube/compare/v0.34.0...v0.34.1) (2020-01-29)


### Bug Fixes

* **plugin-http:** avoid ENAMETOOLONG error for temporary website downloads ([95647de](https://github.com/critocrito/sugarcube/commit/95647de))
